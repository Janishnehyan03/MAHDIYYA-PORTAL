  ...
  return (
    <section id="about" className="lg:flex justify-between ">
      <div className="lg:w-[500px] lg:mt-[4rem]">
        <h2 className="font-bold mb-4 font-sans uppercase text-white">About Us</h2>
        <p>
        ...
        <Link
          to={"/about-us"}
          className="bg-blue-600  px-3 py-1 rounded-[20px] hover:bg-transparent border mt-5 border-teal-500 hover:cursor-pointer hover:text-white transition text-white"
        >
          Know More
        </Link>
      </div>
