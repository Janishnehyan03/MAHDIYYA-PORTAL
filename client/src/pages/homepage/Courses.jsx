    ...
    <section className=" w-full bg-gray-100 lg:p-[5rem]">
      ...
      <div className="grid lg:mx-autogrid-cols-1 lg:grid-cols-3 gap-x-3">
        {courses.slice(0, 3).map((course, i) => (
          <div className="bg-gray-900 relative p-[1rem] rounded-t-[20px] rounded-b-[20px] mt-2 mb-2 lg:mb-0">
            <img
            ...
            <div className="mt-3">
              ...
              <button
                ...
                className="w-full absolute bottom-1 left-0 bg-blue-600 text-white font-bold uppercase py-3 rounded-[30px] hover:bg-[#0f604b] "
              >
                apply now
              </button>
            </div>
      ...
      <div className="w-full flex-1 text-center items-center" >
        <Link
          to={"/all-courses"}
          className="text-white font-semibold text-center ml-3  px-4 py-2 hover:text-white border-teal-500 border rounded-[30px] my-3  hover:bg-blue-600"
        >
          view more
        </Link>
      </div>
