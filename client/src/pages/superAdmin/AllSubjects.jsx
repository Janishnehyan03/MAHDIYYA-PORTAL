    ...
    <>
      ...
      {!openSubject && (
        <button
          ...
          className="bg-blue-600  rounded-full hover:bg-blue-600 mt-3 text-white py-2 px-3 focus:outline-none focus:shadow-outline uppercase transition absolute right-2"
        >
          add subject
